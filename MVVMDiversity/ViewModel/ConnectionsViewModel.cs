...
namespace MVVMDiversity.ViewModel
{
    ...
    public class ConnectionsViewModel : PageViewModel
    {
        ...
        public ICommand ConnectRepository { get; private set; }
        ...
        private bool _repositoryConnecting;
            ...
            : base("ConnectionsPage_NextText", "", "ConnectionsPage_Title", "ConnectionsPage_Description")
        {
            ...
            this._repositoryConnecting = false;
            ...
            ConnectRepository = new RelayCommand<SecureString>(
                (securePassword) =>
                {
                    this._repositoryConnecting = true;

                    var uOptions = UserOptions.getOptions();
                    string pass = (uOptions.PasswordVisible)? Password : securePassword.ToString();
                    new Action(()=>
                    {
                        ...
                        _repositoryConnecting = false;
                    }).BeginInvoke(null,null);
                },
                (securePassword) =>
                {
                    return !this._repositoryConnecting && loginInformationFilled(securePassword);
                });
            ...
            ConnectMobile = new RelayCommand(
                () =>
                {
                    ...
                    ConnectionManager.connectToMobileDB("", "");
                    this._mobileConnecting = false;
                },
            ...
            NextPage = ViewModelLocator.ProjectSelectionStatic;
            PreviousPage = null;
        ...
        private void updateFromSettings(DiversityUserOptions settings)
        {
            if (settings != null)
            {
                ...
                MobileDBPath = settings.MobileDB;
                MobileTaxaPath = settings.MobileTaxa;
            }
        }
        ...
        private bool loginInformationFilled(SecureString securePass)
        {
            bool passwordEntered = (IsPasswordVisible)? !string.IsNullOrEmpty(Password) : securePass != null;
            return !string.IsNullOrEmpty(UserName) && passwordEntered;                                    
        }
